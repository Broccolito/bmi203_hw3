...
[ TODO ] Complete the KMeans class with your implementation of the algorithm
  ...
  [DONE ] complete the `fit` method  
  [DONE] complete the `predict` method  
  [DONE] complete the `get_error` method  
  [DONE] complete the `get_centroid` method  

[ TODO ] Complete the Silhouette class with your implementation of the metric
  [DONE] complete the `score` method  

[ TODO ] Unit Testing  
  [DONE] KMeans Class  
  [DONE] Silhouette Class -- make sure to test against sklearn

[ TODO ] Packaging  
  [DONE] pip installable module  
  [DONE] github actions (install + pytest)  
